...
Your **frontend** talks to **Vercel serverless functions** that does three things: create Dodo customers with wallets, call ElevenLabs for audio generation (checking and debiting the wallet server-side), and call Dodo for payment sessions. When a payment succeeds, a **webhook** credits the customer's wallet automatically. No database needed, Dodo Wallets are the source of truth.

<Frame>
  ![Whats App Image2026 02 28at10 24 31AM](/images/WhatsAppImage2026-02-28at10.24.31AM.jpeg)

  _Here's how credits get added after a purchase_

  ![Whats App Image2026 02 28at10 24 14AM](/images/WhatsAppImage2026-02-28at10.24.14AM.jpeg)
</Frame>
