...
<video src="/videos/Astute_Platinum_Saga.mp4" controls={true} />
...
![Credit flow: Enter text → Enough credits? → Yes: generate + deduct + play. No: show pricing modal.](/images/credit-flow.svg)
