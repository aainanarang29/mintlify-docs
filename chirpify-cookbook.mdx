...
**Frontend** → **Vercel Serverless Functions** → **ElevenLabs TTS API**

↕

**Dodo Payments Wallets API** (credit store) ← **Webhook** (`payment.succeeded`)
...
<Accordion title="Full tech stack">
  ...
  | Backend  | Node.js 18+, Vercel Serverless   | Five API routes: customer, balance, checkout, speak, webhook.             |
  ...
  | State    | Dodo Wallets                     | Server-side credit balance. Tamper-proof. Auditable ledger. No DB needed. |
</Accordion>
